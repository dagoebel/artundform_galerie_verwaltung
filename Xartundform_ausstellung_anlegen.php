...
/**
 * Class artundform_ausstellung_anlegen
 *
 ...
 * @package    Controller
 */
class artundform_ausstellung_anlegen extends BackendModule
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'artundform_ausstellung_anlegen';
	...
	{
		// Create files
		if ($this->Input->post('FORM_SUBMIT') == 'artundform_ausstellung_anlegen')
		{
